...
public class BlockPidsNyc extends BlockPIDSBase implements DirectionHelper, PaDisplayBlock {
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView view, BlockPos pos, ShapeContext context) {
        ...
        double[] shape = style.shape(primary);
        return IBlock.getVoxelShapeByDirection(shape[0], shape[1], shape[2], shape[3], shape[4], shape[5], facing);
    }
    ...
    public ActionResult onUse2(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        ActionResult result = super.onUse2(state, world, pos, player, hand, hit); // brush → MTR config screen
